...
<head>
    ...
    <meta name="apple-mobile-web-app-title" content="Day la Shop">
    <meta name="msapplication-TileImage" content="{{asset('assets/images/favicon.ico')}}">
    <meta name="msapplication-TileColor" content="#FFFFFF">
    <meta http-equiv="X-UA-Compatible" content="IE=edge">
    <meta http-equiv="X-UA-Compatible" content="IE=edge">
    <meta name="description" content="Day la Shop">
    <meta name="keywords" content="Day la Shop">
    <meta name="author" content="Day la Shop">
    <link rel="preconnect" href="https://fonts.gstatic.com">

    <title>Day la Shop</title>
                    ...
                    <div class="col-xl-3 col-lg-4 col-md-6">
                        <div class="footer-contact">
                            ...
                            <ul class="contact-lists" style="clear:both;">
                                ...
                                <li>
                                    <span><b>Address:</b><span class="font-light"> Thừa Thiên Huế, Việt Nam</span></span>
                                </li>
                                <li>
                                    <span><b>Email:</b><span class="font-light"> tranlam@gmail.com</span></span>
                                </li>
                            </ul>
                        </div>
                    </div>
